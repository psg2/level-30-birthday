...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: 'Level 30 · Pedro Sereno' },
      {
        name: 'description',
        content:
          'Você está convidado(a) para a festa de 30 anos do Pedro Sereno. 14 de Março de 2026.',
      },
      { property: 'og:title', content: 'Level 30 · Pedro Sereno' },
      {
        property: 'og:description',
        content:
          'O palco está montado. Você está convidado(a) para a festa do ano.',
      },
    ],
    links: [
      {
